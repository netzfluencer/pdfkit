...
class EmbeddedFont extends PDFFont {
  ...
  embed() {
    ...
    // Optionally allow to disable the CIDSet Generation as the fonts do not pass VeraPDF
    // validation for PDF/A-3 when CIDSets are created through this block
    if (this.document.subset && !this.document.subsetDisableCIDSetGeneration) {
